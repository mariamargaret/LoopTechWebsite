        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2>Text to Speech - Azure OpenAI</h2>
              <ul>
                <li>
                  You can use Azure AI Speech to converse with Azure OpenAI Service. 
                </li>
                <li>
                The text recognized by the Speech service is sent to Azure OpenAI. 
                </li>
          ...
          <div class="col-lg-3">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Category</strong> <span>Gen AI - OpenAI -Azure Speech Service </span></li>
